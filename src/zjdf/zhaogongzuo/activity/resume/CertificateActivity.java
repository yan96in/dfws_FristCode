...
public class CertificateActivity extends Activity {
	...
	private RadioButton r1, r2, r3, r4, r5, r6;// 三个单选按钮
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.layout_my_resume_certificate);
	...
	private View.OnClickListener clickListener = new OnClickListener() {
		...
		private void clickListener(View v) {
			...
			case R.id.but_set:
				...
				it1.putExtra("Certificate", value);

...
import zjdf.zhaogongzuo.ui.SalarysSelectDialog;
 ...
 * @modify 
 */
public class OptSalarysActivity extends Activity {
	...
	/**选项对话框*/
	private SalarysSelectDialog selectionsDialog;
...
/*		mode_code=JobFavoriteActivity.desiredJob.desired_salary_mode_key==null?"1":JobFavoriteActivity.desiredJob.desired_salary_mode_key;
	...
	private void initDialog(){
		...
		selectionsDialog=new SalarysSelectDialog(context);
		selectionsDialog.setOnDataFlashListener(new IflashViewsCallbacks() {
	 ...
	 * @modify
	 */
	public static interface IflashViewsCallbacks{

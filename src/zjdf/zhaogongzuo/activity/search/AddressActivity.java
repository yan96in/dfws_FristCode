	...
	private View.OnClickListener listener=new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			if (v==unlimited) {
				...
				((Activity)context).setResult(SearchFragment.REQUESTCODE_ADDRESS, intent);
				finish();
			}
		}
	};
...
//				scroll_page_sub.requestFocus();
	...
	private void initLocalArea(){
		if (AddressController.mArea!=null) {
			localAreaView.setArea(AddressController.mArea);
...
//											}
	...
	private void startIntent(){
		...
		intent.putExtra(AREA_CODE, code);
		intent.putExtra(AREA_VALUE, value);
		this.setResult(SearchFragment.REQUESTCODE_ADDRESS, intent);
	}

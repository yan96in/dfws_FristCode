 ...
 * 
 */
public class JobPlaceActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.layout_more_job_subscribe_jobplace);
						...
						if (area.getHassub() == 1) {
							...
							if (!flag) {
								...
								if (textViewMap.size() < 5) {
									...
									CustomMessage.showToast(context, "超出5个了", Gravity.CENTER, 0);
								}
								// startIntent();
								// finish();
							} else {

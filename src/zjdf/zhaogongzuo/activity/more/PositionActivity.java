...
public class PositionActivity extends Activity {
	private ImageButton position_return;// 返回
	// private Button position_submit;// 提交
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.layout_more_job_subscribe_position);
		context = this;
		initView();
		initAnimations();
		initDatas();
	...
	private void initView() {
		...
		position_return = (ImageButton) findViewById(R.id.position_return);
		// position_submit = (Button) findViewById(R.id.position_submit);
	...
	private View.OnClickListener listener = new OnClickListener() {
		...
		private void listener(View v) {
			...
			// 提交
			/*
			 * case R.id.position_submit:
			 * 
			 * break;
			 */
			// 返回
			case R.id.position_return:
				finish();
				break;

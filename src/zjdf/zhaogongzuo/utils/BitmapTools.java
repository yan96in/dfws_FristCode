...
public class BitmapTools {
	 ...
	 * @return
	 */
	public static synchronized boolean loadImage(String folder, String url,
			String suffix) {
		try {
	 ...
	 * @return
	 */
	public static synchronized void loadImage(String folder, String url,
	 ...
	 * @return
	 */
	public static void loadIconAndStore(String folder, String url, String name,
			boolean fullName) {
		try {
			// 注意url可能包含?的情况，需要在?前截断
			if (url.indexOf("?") > 0) {
	 ...
	 * @return
	 */
	public static Drawable loadImageFromUrlAndStore(String folder, String url,
			boolean fullName) {
		try {
			// 注意url可能包含?的情况，需要在?前截断
			if (url.indexOf("?") > 0) {

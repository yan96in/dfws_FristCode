 ...
 * 
 */
public class PositionSingleListAdapter extends BaseAdapter {
	...
	public PositionSingleListAdapter(Context context,List<Position> positions){
		if (positions==null) {

 ...
 * 
 */
public class PositionAdapters extends BaseAdapter {
	...
	public PositionAdapters(Context context,List<Position> positions,ListView listView){
		if (positions==null) {
		...
		if (null!=mPositions&&mPositions.size()>0) {
			...
			listView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,int position, long id) {
					// TODO Auto-generated method stub
					int index = (int) id;
					String ids = getItemObjectId(index);	   
					Intent intent = new Intent(mContext,PositionInfoActivity.class);			
					intent.putExtra("position_id", ids);			
					mContext.startActivity(intent);
				}
			});
			holder.cbx_position_status.setChecked(itemStatus[position]);
			holder.cbx_position_status.setOnCheckedChangeListener(new MyCheckBoxChangedListener(mPosition));
		}
		return cView;
	}
	...
	private class ViewHolder{
		...
		/**选中状态*/
		public CheckBox cbx_position_status;
		/**职位名称*/
		public TextView txt_position_name;
		/**所属公司*/
		public TextView txt_position_company;
		/**更新日期*/
		public TextView txt_position_date;
		/**是否是热门职位*/
		public ImageView iv_position_hot;
		/**薪资范围*/
		public TextView txt_position_salary;
		/**工作地点*/
		public TextView txt_position_address;
	}

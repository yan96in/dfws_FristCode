...
//					5000);
			...
			HttpParams params2=post.getParams();
			HttpConnectionParams.setConnectionTimeout(params2, 3000);
			HttpConnectionParams.setSoTimeout(params2, 8000);
	 ...
	 * @return JSon data or "".
	 */
	public static String getNetString_post(List<NameValuePair> params, String uri) {
		String strResult = "";
		DefaultHttpClient client = new DefaultHttpClient();
		try {
//			client.getParams().setParameter(
...
//					5000);
	 ...
	 * @return JSon data or "".
	 */
	public static String getNetString_post(List<NameValuePair> params, String uri,int connection_timeout,int so_timeout) {
		String strResult = "";
		DefaultHttpClient client = new DefaultHttpClient();
		try {
//			client.getParams().setParameter(
...
//					so_timeout);
	 ...
	 * @return
	 */
	public static String getNetString_get(String url) {

 ...
 * 
 */
public class IndustryItemView extends RelativeLayout{
	 ...
	 * @param attrs
	 */
	public IndustryItemView(Context context, AttributeSet attrs) {
		super(context, attrs);
...
//	 * @param area
//	 */
//	public void setOptEntity(OptionEntity opt) {
//		this.opt=opt;
//		initDatas();
//	}
	 ...
	 * @param area
	 */
	public void setOptEntity(OptionEntity opt,boolean state) {
		this.opt=opt;
		initDatas(state);
	}
...
//				iv_next.setVisibility(View.GONE);
//			}
//			if (AddressActivity.code.equals(opt.code)) {
...
//	}
	 ...
	 * @return
	 */
	public OptionEntity getOptEntity(){
		return opt;
	}

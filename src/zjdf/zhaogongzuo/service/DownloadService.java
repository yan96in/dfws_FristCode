...
public class DownloadService extends Service 
{
	...
	private void createNotification(int notifyId) 
    {
    	...
    	{
    		case NOTIFY_DOW_ID:
    	        int icon = R.drawable.circle_small_01;  
    			...
    			break;
    		case NOTIFY_OK_ID:
    			int icon2 = R.drawable.circle_small_01; 
    ...
    {  
    	...
    	try 
    	{
        	...
        	FileAccess.MakeDir(FrameConfigures.FOLDER+"/apk");
        	downFile = new File(FrameConfigures.FOLDER_AREA+"/apk/", "meadinreader"+version+".apk");     	
        	//写入文件夹
